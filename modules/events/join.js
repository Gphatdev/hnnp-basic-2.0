...
const { existsSync, mkdirSync, createReadStream } = require("fs-extra");
...
module.exports.run = async function({ api, event, Users }) {
	...
	if (addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
		...
		return api.sendMessage(`Hellooooooooooo <3`, threadID);
	}
	else {
		try {
			...
			for (const participant of addedParticipants) {
				const id = String(participant.userFbId);
				const userName = participant.fullName || id;
