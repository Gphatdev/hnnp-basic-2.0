module.exports = function ({ api, models, Users, Threads, Currencies }) {
   const stringSimilarity = require('string-similarity'), escapeRegex = (str) => str.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), logger =  require("../../utils/log.js");
    ...
    const prefixRegex = new RegExp(`^(<@!?${senderID}>|${escapeRegex((threadSetting.hasOwnProperty("PREFIX")) ? threadSetting.PREFIX : PREFIX )})\\s*`);
        ...
        if (body.trim() === currentPrefix) {
            return api.sendMessage(`📌Vui Lòng Gõ Help Để Xem Danh Sách Lệnh\n-----------------------------------------------\n🕰️Uptime: ${formatUptime()}`, threadID, messageID);
        }
        ...
        if (!command) {
            ...
            else return api.sendMessage(`❌ Lệnh Không Tồn Tại ❌\n==================\n🔍Lệnh Gần Giống: ${checker.bestMatch.target}\n==================\n🕰️Uptime: ${formatUptime()}`, threadID, messageID);
        }  
