...
const createHumanSend = require('./utils/humanSend');
const cleanupStartupFiles = require('./utils/cleanup');
...
console.log(bannerGradient.multiline(figlet.textSync('NKNP AGENCY', {
  font: 'ANSI Shadow',
